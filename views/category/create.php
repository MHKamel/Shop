          ...
          if(isset($_POST['cat_name']) && $_POST['cat_name']){
            ...
            $newCategory = new CategoryControl;
            $catName = $_POST['cat_name'];
            $addCategory = $newCategory -> create($conn , $catName);
            header('Location: ../../data.php');
          }
          elseif(!isset($_POST['cat_name'])){
            $msg = 'enter categeroy name';
          }
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <form method='post' action="">
              Category Name : <input name='cat_name' type='input' placeholder="<?= $msg ?>" required>
